...
// 为每一项表单验证添加说明文字
  validationMessage = {
    ...
    sex: {
      minlength: '密码长度最少为1个字符', maxlength: '密码长度最多为1个字符', required: '请填写用户性别',
      notdown: '用户性别只能是男或女', only: '用户密码只能包含文字、字母'
    },
    email: {
    ...
    address: {
      minlength: '密码长度最少为6个字符', maxlength: '密码长度最多为10个字符', required: '请填写地址',
